    ...
    <div class="right">
      ...
      <div class="main-cat">
        ...
        <form method="post" action="refer-form.php">
          ...
          <input required="required" type="text" name="yourEmail" value="email" onFocus="if(this.value=='email'){this.value=''}" onBlur="if(this.value==''){this.value='email'}" />
          <label>Friends Email</label>
          <input required="required" type="text" name="thereEmail" value="email" onFocus="if(this.value=='email'){this.value=''}" onBlur="if(this.value==''){this.value='email'}" />
          <?php
